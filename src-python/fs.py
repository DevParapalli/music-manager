...
@fs_router.get("/file/read")
def get_file_content(file: str):
    return FileResponse(file)


# Maybe Queue a song for download ??
"""
def download_song(*args, **kwargs):
    # using youtube-dl ?


@fs_router.post("/file/download")
def download(path: str):
    # insert 202 Accepted functionality
"""
